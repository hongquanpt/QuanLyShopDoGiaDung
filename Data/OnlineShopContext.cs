...
public partial class OnlineShopContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=QUAN\\QUAN;Initial Catalog=OnlineShop;Integrated Security=True;Persist Security Info=False;Pooling=False;Encrypt=False;App=EntityFramework");
